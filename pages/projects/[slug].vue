...
<template>
  <div v-if="isHydrated && project" :class="[
    ...
    <div :class="{ 'opacity-0': !pageLoaded }" class="transition-opacity duration-700 ease-out">
      ...
      <div class="max-w-7xl mx-auto mb-8 px-4 transition-all duration-700 ease-out delay-100"
        :class="{ 'opacity-0 translate-y-[-10px]': !pageLoaded }">
        <nav :class="[
          ...
          <button @click="goToProjects" :class="[
          ...
          <button v-if="currentCategory" @click="goToProjects" :class="[
      ...
      <div class="max-w-7xl mx-auto px-4 transition-all duration-1000 ease-out delay-300"
          ...
          <div class="relative">
            <div :class="[
              ...
              <button @click="prevImage" :class="[
                ...
                <svg class="w-5 h-5" :class="colorMode.value === 'dark' ? 'text-slate-200' : 'text-gray-700'"
        ...
        <div v-else class="text-center py-20">
          <svg class="w-24 h-24 mx-auto mb-4 transition-colors duration-300"
            :class="colorMode.value === 'dark' ? 'text-slate-700' : 'text-gray-300'" fill="none" stroke="currentColor"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <Transition enter-active-class="transition-all duration-500 ease-out"
        leave-active-class="transition-all duration-500 ease-in" enter-from-class="opacity-0 backdrop-blur-none"
        enter-to-class="opacity-100 backdrop-blur-md" leave-from-class="opacity-100 backdrop-blur-md"
        ...
        <div v-if="isLightboxOpen" @click="closeLightbox"
          ...
          <Transition mode="out-in" enter-active-class="transition-all duration-700 ease-out"
            leave-active-class="transition-all duration-700 ease-in" enter-from-class="opacity-0 scale-95"
            leave-to-class="opacity-0 scale-105">
            <img :key="selectedImageIndex" :src="getImages()[ selectedImageIndex ].image" alt="Project image"
  ...
  <div v-else class="min-h-screen flex items-center justify-center"
    :class="colorMode.value === 'dark' ? 'bg-slate-950' : 'bg-white'">
            ...
            <div :class="[
              ...
              <div>
                <p :class="colorMode.value === 'dark' ? 'text-gray-500' : 'text-gray-600'"
                  class="text-xs tracking-wider mb-2">0{{ step.id }}.</p>
                <h3 :class="colorMode.value === 'dark' ? 'text-white' : 'text-black'"
                  class="font-bold text-sm mb-3 line-clamp-2">{{ step.title }}</h3>
                <p :class="colorMode.value === 'dark' ? 'text-gray-400' : 'text-gray-700'"
                  class="text-xs leading-relaxed">{{ step.description }}</p>
              </div>
            </div>
        ...
        <div class="flex justify-between items-start gap-6">
          <div v-for="step in bottomSteps" :key="step.id" class="flex flex-col items-center flex-1">
            ...
            <div :class="[
              ...
              <p :class="colorMode.value === 'dark' ? 'text-gray-500' : 'text-gray-600'"
                class="text-xs tracking-wider mb-2 text-center">0{{ step.id }}.</p>
              <h3 :class="colorMode.value === 'dark' ? 'text-white' : 'text-black'"
